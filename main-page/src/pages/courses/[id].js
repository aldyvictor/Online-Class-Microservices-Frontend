                        ...
                        <div className='meta-price w-full bg-white z-50 left-0 py-3'>
                            <div className='w-3/4 mx-auto'>
                                <div className="flex items-center">
                                    ...
                                    <a href={`${process.env.NEXT_PUBLIC_MEMBERPAGE_URL}/joined/${data.id}`} target='_blank' rel='noopener norefferer' className="bg-orange-500 hover:bg-orange-400 transition-all duration-200 focus:outline-none shadow-inner text-white px-6 py-3 whitespace-nowrap">
